export const translations = {
  es: {
    ...
    seeker: {
      ...
      // FIX: Corrected wrong translation from French to Spanish.
      share: 'Compartir',
      ...
      editRequest: 'Editar Solicitud para',
      requestDetails: 'Detalles de la necesidad',
      cancelServiceRequest: 'Cancelar Solicitud',
      confirmCancelRequest: '¿Está seguro de que desea cancelar su solicitud de servicio para',
      noKeep: 'No, mantener',
    ...
    help: {
      ...
      seeker: {
        ...
        faqs: [
          { q: '¿Cómo busco un empleo?', a: 'Ve a la sección "Búsqueda Avanzada", selecciona la pestaña "Empleos", introduce tus criterios de búsqueda (palabra clave, ciudad) y haz clic en "Buscar".' },
          { q: '¿Cómo me postulo a un empleo?', a: 'Una vez que encuentres un empleo que te interese, haz clic en "Ver Detalles". Si estás convencido, haz clic en "Desbloquear y Postularse". Es posible que necesites una membresía o realizar un pago único.' },
          { q: '¿Cómo contacto a un profesional?', a: 'Busca profesionales en la sección "Búsqueda Avanzada". Una vez que encuentres uno, haz clic en "Ver Perfil" para más detalles y luego en "Contactar" para enviar una solicitud de servicio.' },
          { q: '¿Cómo puedo calificar a un recomendador o profesional?', a: 'Después de postularte a un empleo o de que un servicio sea marcado como finalizado, verás un botón de "Calificar" en tus historiales de "Mis Postulaciones" o "Mis Solicitudes de Servicio".' }
        ]
      },
      professional: {
  ...
  en: {
    ...
    // Errors
    errorAllFields: 'Please complete all fields and select a role.',
    ...
    reauthenticationNeeded: 'Please enter your current password to confirm changes.',

    // Recommender Dashboard
    recommender: {
        dashboardTitle: 'Recommender Dashboard',
        publishNewJob: 'Publish New Job',
        publishJobDescription: 'Know of an amazing job opportunity? Share it with the community of professionals.',
        jobTitle: 'Job Title',
        ...
        contactPhonePlaceholder: 'e.g., +44 20 7946 0958',
        ...
        photoCaptured: 'Photo captured. Do not forget to save the changes.',
        ...
        importantNotice: 'Important: All payments are subject to conditions and prior verifications, such as the veracity of the job and the effective hiring of the recommended person.',
        ...
        noApplicantsYet: 'No applicants for this job yet.',
        ...
        shareJob: {
            ...
            text: "Check out this job opportunity for {jobTitle} at {companyName} I found on teRecomiendo!"
        },
        earnings: {
            title: 'My Earnings',
            pending: 'Pending',
        ...
        applicationForwarded: 'Application forwarded to the company.',
        applicationRejected: 'Application rejected.',
        statusUpdated: 'Status updated.',
        errorUpdatingStatus: 'Error updating status.',
        errorForwarding: 'Error forwarding application.',
    ...
    seeker: {
        ...
        professionalProfile: "Professional's Profile",
        ...
        contactAndProfileTitle: 'Profile and Contact: {name}',
        ...
        premiumAccessDescription: 'To view full company details and apply, choose an option:',
        recommendedOption: 'Recommended Option',
        acquireMembership: 'Buy Membership',
        membershipBenefit: 'Access all job applications without limits.',
        buyFor: 'Buy for',
        singlePayment: 'Single Application Payment',
        singlePaymentDescription: 'Unlock this job offer for a one-time payment of',
        pay: 'Pay',
        applyTo: 'Apply to',
        ...
        editRequest: 'Edit Request for',
        requestDetails: 'Need details',
        cancelServiceRequest: 'Cancel Request',
        confirmCancelRequest: 'Are you sure you want to cancel your service request for',
        noKeep: 'No, keep',
        ...
        applicationEmailBody: '<h1>New Application Received</h1><p>You have received a new application for the job <strong>{jobTitle}</strong> from <strong>{seekerName}</strong>.</p><p><strong>Cover Letter:</strong></p><p>{coverLetter}</p><p>You can view the candidate\'s CV at the following link: <a href="{cvUrl}">View CV</a></p><p>Thank you,<br>The teRecomiendo Team</p>',
        seekerApplicationEmailBody: '<h1>Application Confirmation</h1><p>Hi {seekerName},</p><p>We have successfully received your application for the <strong>{jobTitle}</strong> position at <strong>{companyName}</strong>.</p><p>Your confirmation number is: <strong>{confirmationNumber}</strong>.</p><p>We wish you the best of luck!</p><p>Thank you,<br>The teRecomiendo Team</p>',
        jobFullEmailSubject: 'Your job post "{jobTitle}" has reached the applicant limit!',
        jobFullEmailBody: '<h1>Congratulations!</h1><p>Your job post <strong>{jobTitle}</strong> has reached the maximum number of applicants and is now closed to new applications.</p><p>You can review the candidates from your recommender dashboard.</p><p>Thank you,<br>The teRecomiendo Team</p>',
        applyNow: 'Apply Now',
        ...
        jobUnlockedSuccess: 'Job unlocked! You can now view the contact details.',
        applicationStatusTracker: 'Application Tracking',
        tracker: {
            step1: 'Application Sent',
            step2: 'Recommender Review',
            step3: 'Forwarded to Company',
        ...
        applicationStatus: {
            ...
            forwarded_to_company: 'Your profile has been sent to the company!',
    ...
    professional: {
        ...
        profileRejected: 'Your profile has been rejected. Please review its content and resubmit.',
        myPublicProfile: 'My Public Profile',
        addYourSpecialty: 'Add your specialty',
        addYourBio: 'Add a bio to attract clients.',
        contactInfo: 'Contact Information',
        email: 'Email',
        phone: 'Phone',
        notSpecified: 'Not specified',
        ...
        phonePlaceholder: 'e.g., +44 20 7946 0958',
        manageServices: 'Manage Services',
        noServicesAdded: 'No services added.',
        addNewServicePlaceholder: 'Add new service',
        idForVerification: 'ID Document (for verification)',
        idUploadNotice: 'Uploading a new document will send it for review.',
        unlockContact: 'Unlock Contact',
        unlockContactDescription: "To view the client's full details and contact them, choose an option:",
        recommendedOption: 'Recommended Option',
        ...
        singleUnlockPayment: 'Single Unlock Payment',
        singleUnlockDescription: 'Unlock this specific request for a one-time payment of',
        pay: 'Pay',
    ...
    admin: {
        ...
        errorSavingPayoutSettings: 'Error saving payout settings.',
        ...
        sendTest: 'Send Test',
        sendingTest: 'Sending...',
        testEmailSent: 'Test email sent to the queue. Check the inbox for {email}.',
        ...
        management: {
            ...
            noPendingHires: 'No applications pending hire.',
    ...
    emails: {
        ...
        welcomeBodySeeker: `
          <h1>Welcome to Te Recomiendo! 👋</h1>
          ...
          <ul>
            ...
            <li>✅ Connect with professionals who offer services</li>
          </ul>
          <p>This is the first step towards a new professional opportunity.<br>We are happy to have you here!</p>
          <p>👉 Log in to your dashboard: <a href="https://terecomiendo.ca">https://terecomiendo.ca</a></p>
        `,
        welcomeBodyRecommender: `
          <h1>Welcome to Te Recomiendo! 🙌</h1>
          <p>Thank you for joining as a recommender and being part of a network that helps others find work and earns commissions.</p>
          <p>On our platform, you can:</p>
          <ul>
            <li>✅ Post job opportunities</li>
            <li>✅ Recommend candidates and help them apply</li>
            <li>✅ Receive notifications when your referrals apply</li>
            <li>✅ Generate income through your posts</li>
          </ul>
        ...
        seekerToCompany: {
            ...
            body: `
                ...
                <p>The user <strong>{seekerName}</strong> has applied for your vacancy: <strong>{jobTitle}</strong>.</p>
                <hr>
                ...
                <ul>
                    ...
                    <li><strong>Attachment:</strong> <a href="{cvUrl}">View Resume</a></li>
                </ul>
                <hr>
                <h3>Recommender:</h3>
                <ul>
                ...
                <ol>
                    <li><strong>INTERESTED</strong> — I want to contact the candidate</li>
                    <li><strong>FOR INTERVIEW</strong> — Send suggested date and time</li>
                    <li><strong>NOT SELECTED</strong> — Does not meet the profile</li>
                    <li><strong>POSITION ALREADY FILLED</strong> — We have hired the candidate</li>
                </ol>
                <p>Your response will be automatically registered on the platform for traceability.</p>
                <br>
                <p>Thank you very much,<br><strong>Te Recomiendo</strong><br><em>Your platform that connects talent with job opportunities.</em></p>
                <p><a href="https://terecomiendo.ca">https://terecomiendo.ca</a></p>
            `
        },
        seekerToRecommender: {
            ...
            body: `
                ...
                <p>The candidate <strong>{seekerName}</strong> has applied to the job offer "<strong>{jobTitle}</strong>" that you posted.</p>
                <p><strong>Cover Letter:</strong></p>
                <p><em>{coverLetter}</em></p>
                <p><strong>Attachment:</strong> <a href="{cvUrl}">View Resume</a></p>
        ...
        failedLoginsWarningBody: '<h1>Security Alert</h1><p>Hi,</p><p>We have detected multiple failed login attempts for your account. If this was not you, we recommend that you reset your password immediately.</p>',
        passwordChangedSubject: 'Password Change Confirmation',
        passwordChangedBody: '<h1>Your password has been changed</h1><p>Hi {name},</p><p>This email confirms that your account password has been successfully changed. If you did not make this change, please contact our support immediately.</p>',
        professional: {
            profileSubmittedSubject: 'Your professional profile is under review',
            profileSubmittedBody: '<h1>We have received your profile</h1><p>Hi {name},</p><p>Thank you for submitting your professional profile. Our team will review it and notify you once it is approved. This process usually takes 24 to 48 hours.</p>',
            ...
            newServiceRequestBody: '<h1>You have a new request</h1><p>Hi {name},</p><p>You have received a new service request from <strong>{seekerName}</strong>. Log in to your dashboard to view the details and respond.</p>',
            ratingReminderSubject: "Reminder to rate our service",
            ratingReminderBody: "<h1>Hello {seekerName}!</h1><p>We hope you are satisfied with our service. <strong>{professionalName}</strong> would appreciate it if you took a moment to leave a rating.</p><p>Your feedback is very valuable to us and the teRecomiendo community.</p><p><a href='https://terecomiendo.ca'>Click here to rate</a></p><p>Thank you!</p>"
        },
        recommender: {
            jobPublishedSubject: 'You have published a new job offer',
            jobPublishedBody: '<h1>Offer Published!</h1><p>Hi {name},</p><p>Your job offer "<strong>{jobTitle}</strong>" has been published correctly. It is now pending verification by an administrator.</p>',
            jobVerifiedSubject: 'Your job offer has been verified!',
            jobVerifiedBody: '<h1>Offer Verified!</h1><p>Hi {name},</p><p>Your job offer "<strong>{jobTitle}</strong>" has been verified by our team. Thank you for your contribution! You have earned ${amount} for this action.</p>',
            ...
            forwardedToCompanyBody: `
              <p>Hello {companyName},</p>
              <p>User <strong>{seekerName}</strong> has applied for your vacancy: <strong>{jobTitle}</strong>, through our platform teRecomiendo.</p>
              <hr>
              <h3>Candidate details:</h3>
              <ul>
                <li><strong>Name:</strong> {seekerName}</li>
              ...
              <hr>
              <p><strong>To facilitate the process, you can reply directly to this email indicating one of the following options in the subject line to update the candidate's status on our platform:</strong></p>
              <ul>
                <li><strong>INTERESTED</strong> — To indicate you wish to contact the candidate.</li>
                <li><strong>FOR INTERVIEW</strong> — To indicate the candidate is moving to the interview stage.</li>
                <li><strong>NOT SELECTED</strong> — To indicate the candidate does not fit the profile.</li>
              </ul>
              <p>Your response will be automatically registered on the platform to maintain process traceability.</p>
              <br>
    ...
    help: {
      ...
      seeker: {
        ...
        description: 'Find answers to common questions about finding jobs and professionals.',
        faqs: [
          { q: 'How do I search for a job?', a: 'Go to the "Advanced Search" section, select the "Jobs" tab, enter your search criteria (keyword, city), and click "Search".' },
          { q: 'How do I apply for a job?', a: 'Once you find a job you are interested in, click "View Details". If you are convinced, click "Unlock and Apply". You may need a membership or to make a one-time payment.' },
          { q: 'How do I contact a professional?', a: 'Search for professionals in the "Advanced Search" section. Once you find one, click "View Profile" for more details and then "Contact" to send a service request.' },
          { q: 'How can I rate a recommender or professional?', a: 'After applying for a job or after a service is marked as finished, you will see a "Rate" button in your "My Job Applications" or "My Service Requests" histories.' }
        ]
      },
      professional: {
        title: 'Help for Professionals',
        description: 'Answers on how to manage your profile, services, and client requests.',
        faqs: [
          { q: 'How do I edit my profile?', a: 'On your dashboard, click the "Edit Profile" button. You can update your specialty, bio, services, photo, and contact details. Don\'t forget to upload your ID document for verification.' },
          ...
          { q: 'How do I see the details of a client who requested my service?', a: 'New requests appear with the client\'s data locked. To unlock them, you need an active membership or to make a one-time payment for that request. Click "View Client Data" to see the options.' },
          { q: 'How do I mark a service as finished?', a: 'Once you have unlocked and contacted the client and the service is complete, go to the request on your dashboard and click "Finish Service". You can enter the completion date and rate the client.' }
        ]
      },
      recommender: {
        title: 'Help for Recommenders',
        description: 'Learn how to publish jobs, manage your earnings, and make the most of the platform.',
        faqs: [
          { q: 'How do I publish a new job offer?', a: 'On your dashboard, you will find the "Publish New Job" form. Fill in all the job details such as title, company, and description, and click "Publish Job".' },
          { q: 'How do I earn money as a recommender?', a: 'You earn money in several ways: an amount for each job you publish that is verified, another for each application your offer receives, and a larger commission if a candidate is hired. You can see the rates in the "Official Recommenders Program" section.' },
          { q: 'Where do I see my earnings?', a: 'In the "My Earnings" card on your dashboard, you can see a summary of your pending and paid earnings, as well as the history of payments you have received.' },
          { q: 'What does it mean if a job is "pending verification"?', a: 'It means an administrator is reviewing your post to ensure it is a real job offer and complies with our policies. Once verified, you will receive your corresponding earning.' },
          { q: 'How do I track an application to know if the employee was hired?', a: 'On your dashboard, in the "My Published Jobs" section, click the "Applicants" button on a job post. If an administrator has confirmed a hire, you will see a "HIRED" badge next to the candidate\'s name.' }
        ]
      }
    }
  },
  fr: {
    ...
    resetLinkSent: 'Un lien de réinitialisation de mot de passe a été envoyé à votre adresse e-mail.',

    // Errors
    errorAllFields: 'Veuillez remplir tous les champs et sélectionner un rôle.',
    errorEnterEmailPass: 'Veuillez entrer votre e-mail et votre mot de passe.',
    ...
    reauthenticationNeeded: 'Veuillez entrer votre mot de passe actuel pour confirmer les modifications.',
    ...
    recommender: {
        ...
        areaCodeOptional: 'Code postal (Optionnel)',
        ...
        perYear: 'Par an',
        perHour: 'Par heure',
        contactInfoOptional: 'Coordonnées (Optionnel)',
        ...
        jobPublishedSuccessfully: 'Offre publiée avec succès !',
        errorPublishingJob: "Une erreur s'est produite lors de la publication de l'offre.",
        ...
        couldNotUpdateJob: "Impossible de mettre à jour l'offre.",
        ...
        recommenderProgramDescription: 'Participez en tant que Recommandeur Certifié et aidez plus de personnes à accéder à de vraies opportunités d\'emploi, tout en obtenant des avantages pour votre contribution.',
        ...
        importantNotice: 'Important : Tous les paiements sont soumis à des conditions et à des vérifications préalables, telles que la véracité de l\'emploi et l\'embauche effective de la personne recommandée.',
        ...
        noApplicantsYet: "Aucun candidat pour cette offre pour l'instant.",
        ...
        sending: 'Envoi...',
        noJobsFoundWithFilters: 'Aucune offre trouvée avec les filtres actuels.',
        applicantsModalTitle: 'Candidats pour',
        coverLetterNone: 'Pas de lettre de motivation.',
        cv: 'CV',
        viewCV: 'Voir le CV',
        hired: 'EMBAUCHÉ',
        approveAndForward: 'Approuver & Envoyer',
        ...
        applicationForwarded: 'Candidature transmise à l\'entreprise.',
        applicationRejected: 'Candidature rejetée.',
        statusUpdated: 'Statut mis à jour.',
        errorUpdatingStatus: 'Erreur lors de la mise à jour du statut.',
        errorForwarding: 'Erreur lors de la transmission de la candidature.',
    ...
    seeker: {
        ...
        contactAndProfileTitle: 'Profil et Contact : {name}',
        requestSubject: 'Objet de la demande',
        describeNeed: 'Décrivez votre besoin',
        attachPhotoOptional: 'Joindre une photo (optionnel)',
        ...
        acquireMembership: 'Acheter un abonnement',
        ...
        editRequest: 'Modifier la demande pour',
        requestDetails: 'Détails du besoin',
        cancelServiceRequest: 'Annuler la demande',
        confirmCancelRequest: 'Êtes-vous sûr de vouloir annuler votre demande de service pour',
        ...
        jobFullEmailBody: '<h1>Félicitations !</h1><p>Votre offre d\'emploi <strong>{jobTitle}</strong> a atteint le nombre maximum de candidats et est désormais fermée aux nouvelles candidatures.</p><p>Vous pouvez consulter les candidats depuis votre tableau de bord de recommandeur.</p><p>Merci,<br>L\'équipe de teRecomiendo</p>',
        ...
        proceedToApplication: 'Passer à la candidature',
        jobUnlockedSuccess: 'Offre déverrouillée ! Vous pouvez maintenant voir les coordonnées.',
        applicationStatusTracker: 'Suivi de la Candidature',
        tracker: {
            step1: 'Candidature Envoyée',
            step2: 'Examen du Recommandeur',
            step3: 'Transmis à l\'Entreprise',
    ...
    professional: {
        ...
        searchOnMap: 'Chercher sur la carte',
        openChat: 'Ouvrir le chat',
        finishService: 'Terminer le service',
        clientDataLocked: 'Données du Client Verrouillées',
        unlockToView: 'Déverrouillez pour voir les coordonnées et le lieu.',
        viewClientData: 'Voir les Données du Client',
        noActiveRequests: 'Vous n\'avez reçu aucune demande de service active pour le moment.',
        attendedServicesHistory: 'Historique des Services Effectués',
        finished: 'Terminé',
        ratingGiven: 'Évaluation Donnée',
        ...
        idUploadNotice: 'Télécharger une nouvelle pièce l\'enverra pour révision.',
        ...
        singleUnlockPayment: 'Paiement Unique de Déverrouillage',
        ...
        acquireMembershipDescription: 'Choisissez un plan pour déverrouiller toutes les demandes et améliorer votre visibilité.',
        ...
        schedulePlaceholder: 'Ex: Lundi à Vendredi, 9h - 17h',
    ...
    admin: {
        ...
        globalJobSettings: "Paramètres Globaux des Offres",
        jobDeletionRequests: "Demandes de Suppression d'Offres",
        ...
        maxApplicantsDescription: 'Ce nombre s\'appliquera à toutes les offres d\'emploi. Laissez vide pour aucune limite.',
        ...
        durationDaysHelpText: "Définit la durée de validité de l'abonnement après l'achat.",
        ...
        verifying: 'vérifier',
        unverifying: 'retirer la vérification de',
        ...
        errorDeletingUser: "Une erreur s'est produite lors de la suppression de l'utilisateur.",
        ...
        errorSavingPayoutSettings: 'Erreur lors de l\'enregistrement des paramètres de paiement.',
        jobDeleted: 'Offre et candidatures associées supprimées.',
        errorDeletingJob: "Erreur lors de la suppression de l'offre.",
        deletionRejected: 'Demande de suppression rejetée. L\'offre a été réactivée.',
        ...
        sendingTest: 'Envoi...',
        testEmailSent: "E-mail de test envoyé à la file d'attente. Vérifiez la boîte de réception de {email}.",
        ...
        statusError: 'Erreur de livraison de l\'e-mail : {error}',
        ...
        noDocumentUploaded: "Aucun document n'a été téléchargé.",
        nav: {
            verifications: 'Vérifications',
            hiring: 'Embauches & Paiements',
            users: 'Gestion des Utilisateurs',
            config: 'Paramètres & Tarifs',
        },
        management: {
            manageJobs: 'Gérer les Offres',
            noUnverifiedJobs: 'Aucune offre à vérifier.',
            verifyJob: 'Vérifier l\'Offre',
            manageApplications: 'Gérer les Candidatures',
            noPendingHires: 'Aucune candidature en attente d\'embauche.',
            ...
            paymentTo: 'Enregistrer un Paiement pour',
            amountToPay: 'Montant à Payer',
            paymentNotesOptional: 'Notes (Optionnel)',
            paymentProofOptional: 'Preuve de Paiement (Optionnel)',
            ...
            jobVerifiedSuccess: 'Offre vérifiée ! Un gain a été généré.',
    ...
    emails: {
        ...
        welcomeBodySeeker: `
          <h1>Bienvenue sur Te Recomiendo ! 👋</h1>
          ...
          <ul>
            <li>✅ Accéder à des opportunités réelles</li>
            <li>✅ Postuler avec le soutien d'un recommandeur</li>
            <li>✅ Recevoir des notifications sur le statut de vos candidatures</li>
            <li>✅ Entrer en contact avec des entreprises qui recherchent des talents comme vous</li>
            <li>✅ Entrer en contact avec des professionnels qui proposent des services</li>
          </ul>
        ...
        welcomeBodyRecommender: `
          <h1>Bienvenue sur Te Recomiendo ! 🙌</h1>
          <p>Merci de nous rejoindre en tant que recommandeur et de faire partie d'un réseau qui aide les autres à trouver du travail et gagne des commissions.</p>
          ...
          <ul>
            ...
            <li>✅ Recevoir des notifications lorsque vos recommandations postulent</li>
            <li>✅ Générer des revenus grâce à vos publications</li>
          </ul>
          <p>Votre rôle est essentiel pour créer des connexions qui génèrent de réelles opportunités.<br>Merci de contribuer à cette communauté !</p>
          <p>👉 Accédez à votre compte : <a href="https://terecomiendo.ca">https://terecomiendo.ca</a></p>
        `,
        welcomeBodyProfessional: `
          <h1>Bienvenue sur Te Recomiendo ! 🏢✨</h1>
          <p>Merci de nous rejoindre en tant que professionnel et de faire partie d'un réseau qui aide les autres à résoudre des problèmes et à répondre à des besoins professionnels.</p>
          <p>Sur notre plateforme, vous pourrez :</p>
          <ul>
            <li>✅ Créer et offrir des services vérifiés</li>
            <li>✅ Entrer en contact avec des personnes qui ont besoin de services réels</li>
            <li>✅ Gérer facilement les candidatures depuis votre e-mail</li>
            <li>✅ Trouver des opportunités d'affaires</li>
          </ul>
          <p>Vous faites maintenant partie d'une communauté qui unit le talent des personnes avec les opportunités.</p>
          <p>👉 Entrez dans le portail entreprise : <a href="https://terecomiendo.ca">https://terecomiendo.ca</a></p>
        `,
        seekerToCompany: {
            ...
            body: `
                ...
                <ul>
                    ...
                    <li><strong>Pièce jointe :</strong> <a href="{cvUrl}">Voir le CV</a></li>
                </ul>
                <hr>
                <h3>Recommandeur :</h3>
                <ul>
                ...
                <ol>
                    ...
                    <li><strong>POUR ENTRETIEN</strong> — Envoyer la date et l'heure suggérées</li>
                    <li><strong>NON SÉLECTIONNÉ</strong> — Ne correspond pas au profil</li>
                    <li><strong>POSTE DÉJÀ POURVU</strong> — Nous avons embauché le candidat</li>
                </ol>
                <p>Votre réponse sera automatiquement enregistrée sur la plateforme pour assurer la traçabilité.</p>
                <br>
                <p>Merci beaucoup,<br><strong>Te Recomiendo</strong><br><em>Votre plateforme qui unit les talents et les opportunités d'emploi.</em></p>
                <p><a href="https://terecomiendo.ca">https://terecomiendo.ca</a></p>
            `
        },
        seekerToRecommender: {
            ...
            body: `
                ...
                <p><em>{coverLetter}</em></p>
                <p><strong>Pièce jointe :</strong> <a href="{cvUrl}">Voir le CV</a></p>
        ...
        passwordChangedBody: '<h1>Votre mot de passe a été modifié</h1><p>Bonjour {name},</p><p>Cet e-mail confirme que le mot de passe de votre compte a été modifié avec succès. Si vous n\'avez pas effectué ce changement, veuillez contacter notre support immediately.</p>',
        professional: {
            profileSubmittedSubject: 'Votre profil professionnel est en cours de révision',
            profileSubmittedBody: '<h1>Nous avons reçu votre profil</h1><p>Bonjour {name},</p><p>Merci d\'avoir soumis votre profil professionnel. Notre équipe l\'examinera et vous informera dès qu\'il sera approuvé. Ce processus prend généralement de 24 à 48 heures.</p>',
            ...
            ratingReminderBody: "<h1>Bonjour {seekerName} !</h1><p>Nous espérons que vous êtes satisfait de notre service. <strong>{professionalName}</strong> apprécierait que vous preniez un moment pour laisser une évaluation.</p><p>Votre avis est très précieux pour nous et pour la communauté de teRecomiendo.</p><p><a href='https://terecomiendo.ca'>Cliquez ici pour évaluer</a></p><p>Merci !</p>"
        },
        recommender: {
            jobPublishedSubject: 'Vous avez publié une nouvelle offre d\'emploi',
            jobPublishedBody: '<h1>Offre Publiée !</h1><p>Bonjour {name},</p><p>Votre offre d\'emploi "<strong>{jobTitle}</strong>" a été publiée correctement. Elle est maintenant en attente de vérification par un administrateur.</p>',
            ...
            forwardedToCompanySubject: 'Nouveau candidat pour votre offre [Ref: {applicationId}]',
            forwardedToCompanyBody: `
              <p>Bonjour {companyName},</p>
              <p>L'utilisateur <strong>{seekerName}</strong> a postulé à votre offre : <strong>{jobTitle}</strong>, via notre plateforme teRecomiendo.</p>
              <hr>
              <h3>Coordonnées du candidat :</h3>
              <ul>
                <li><strong>Nom :</strong> {seekerName}</li>
              ...
              <ul>
                ...
                <li><strong>POUR ENTRETIEN</strong> — Pour indiquer que le candidat passe à l'étape de l'entretien.</li>
                <li><strong>NON SÉLECTIONNÉ</strong> — Pour indiquer que le candidat ne correspond pas au profil.</li>
              </ul>
              <p>Votre réponse sera automatiquement enregistrée sur la plateforme pour maintenir la traçabilité du processus.</p>
              <br>
              <p>Merci beaucoup,<br><strong>Te Recomiendo</strong><br><em>La plateforme qui connecte les gens avec les opportunités</em></p>
            `,
        }
    },
    help: {
      ...
      seeker: {
        ...
        description: 'Trouvez des réponses aux questions courantes sur la recherche d\'emplois et de professionnels.',
        faqs: [
          { q: 'Comment rechercher un emploi ?', a: 'Allez dans la section "Recherche Avancée", sélectionnez l\'onglet "Emplois", entrez vos critères de recherche (mot-clé, ville) et cliquez sur "Rechercher".' },
          { q: 'Comment postuler à un emploi ?', a: 'Une fois que vous avez trouvé un emploi qui vous intéresse, cliquez sur "Voir les détails". Si vous êtes convaincu, cliquez sur "Débloquer et Postuler". Vous pourriez avoir besoin d\'un abonnement ou de faire un paiement unique.' },
          { q: 'Comment contacter un professionnel ?', a: 'Recherchez des professionnels dans la section "Recherche Avancée". Une fois que vous en avez trouvé un, cliquez sur "Voir le profil" pour plus de détails, puis sur "Contacter" pour envoyer une demande de service.' },
          { q: 'Comment puis-je évaluer un recommandeur ou un professionnel ?', a: 'Après avoir postulé à un emploi ou après qu\'un service a été marqué comme terminé, vous verrez un bouton "Évaluer" dans vos historiques "Mes Candidatures" ou "Mes Demandes de Service".' }
        ]
      },
      professional: {
        title: 'Aide pour les Professionnels',
        description: 'Réponses sur la gestion de votre profil, de vos services et des demandes de clients.',
        faqs: [
          { q: 'Comment modifier mon profil ?', a: 'Sur votre tableau de bord, cliquez sur le bouton "Modifier le profil". Vous pouvez mettre à jour votre spécialité, biographie, services, photo et coordonnées. N\'oubliez pas de télécharger votre pièce d\'identité pour la vérification.' },
          { q: 'Pourquoi mon profil est-il "en attente de révision" ?', a: 'Tous les profils nouveaux ou modifiés passent par un processus de révision par nos administrateurs pour garantir la qualité et la sécurité de la plateforme. Ce processus prend généralement de 24 à 48 heures.' },
          { q: 'Comment voir les coordonnées d\'un client qui a demandé mon service ?', a: 'Les nouvelles demandes apparaissent avec les données du client verrouillées. Pour les déverrouiller, vous devez avoir un abonnement actif ou effectuer un paiement unique pour cette demande. Cliquez sur "Voir les Données du Client" pour voir les options.' },
          { q: 'Comment marquer un service comme terminé ?', a: 'Une fois que vous avez déverrouillé et contacté le client et que le service est terminé, allez à la demande sur votre tableau de bord et cliquez sur "Terminer le service". Vous pourrez indiquer la date de fin et évaluer le client.' }
        ]
      },
      recommender: {
        title: 'Aide pour les Recommandeurs',
        description: 'Apprenez à publier des emplois, gérer vos gains et tirer le meilleur parti de la plateforme.',
        faqs: [
          ...
          { q: 'Comment gagner de l\'argent en tant que recommandeur ?', a: 'Vous gagnez de l\'argent de plusieurs manières : un montant pour chaque emploi que vous publiez et qui est vérifié, un autre pour chaque candidature que votre offre reçoit, et une commission plus importante si un candidat est embauché. Vous pouvez consulter les tarifs dans la section "Programme Officiel des Recommandeurs".' },
          ...
          { q: 'Que signifie si un emploi est "en attente de vérification" ?', a: 'Cela signifie qu\'un administrateur examine votre publication pour s\'assurer qu\'il s\'agit d\'une offre d\'emploi réelle et qu\'elle respecte nos politiques. Une fois vérifiée, vous recevrez votre gain correspondant.' },
          { q: 'Comment suivre une candidature pour savoir si l\'employé a été embauché ?', a: 'Sur votre tableau de bord, dans la section "Mes offres publiées", cliquez sur le bouton "Candidats" d\'une offre. Si un administrateur a confirmé une embauche, vous verrez un badge "EMBAUCHÉ" à côté du nom du candidat.' }
        ]
      }
    }
  }
